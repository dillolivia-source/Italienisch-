...
window.LESSON_DATA = {
  ...
  vocab: [
    ...
    // --- Soziales / Umgang ---
    { id: "v137", it: "ciao", de: "hallo / tschüss", cefr: "A1", theme: "social", ex: { de: "Hallo, wie geht's?", it: ["Ciao, come stai?"] } },
    { id: "v138", it: "buongiorno", de: "guten Morgen / guten Tag", cefr: "A1", theme: "social", ex: { de: "Guten Morgen zusammen!", it: ["Buongiorno a tutti!"] } },
    { id: "v139", it: "buonasera", de: "guten Abend", cefr: "A1", theme: "social", ex: { de: "Guten Abend!", it: ["Buonasera!"] } },
    { id: "v140", it: "grazie mille", de: "vielen Dank", cefr: "A1", theme: "social", ex: { de: "Vielen Dank!", it: ["Grazie mille!"] } },
    { id: "v141", it: "prego", de: "gern geschehen / bitte", cefr: "A1", theme: "social", ex: { de: "Gern geschehen!", it: ["Prego!"] } },
    { id: "v142", it: "per favore", de: "bitte", cefr: "A1", theme: "social", ex: { de: "Einen Kaffee, bitte.", it: ["Un caffè, per favore."] } },
    { id: "v143", it: "scusa", de: "Entschuldigung", cefr: "A1", theme: "social", ex: { de: "Entschuldige, wie spät ist es?", it: ["Scusa, che ore sono?"] } },
    { id: "v144", it: "mi dispiace", de: "es tut mir leid", cefr: "A2", theme: "social", ex: { de: "Es tut mir sehr leid.", it: ["Mi dispiace molto."] } },
    { id: "v145", it: "come stai", de: "wie geht es dir", cefr: "A1", theme: "social", ex: { de: "Wie geht es dir heute?", it: ["Come stai oggi?"] } },
    { id: "v146", it: "piacere", de: "freut mich", cefr: "A2", theme: "social", ex: { de: "Freut mich, ich bin Anna.", it: ["Piacere, sono Anna."] } },
    { id: "v147", it: "salutare", de: "grüßen", cefr: "A2", theme: "social", ex: { de: "Ich grüße die Nachbarn.", it: ["Saluto i vicini."] } },
    { id: "v148", it: "invitare", de: "einladen", cefr: "A2", theme: "social", ex: { de: "Ich lade dich zum Essen ein.", it: ["Ti invito a cena."] } },
    { id: "v149", it: "l'invito", de: "die Einladung", cefr: "A2", theme: "social", ex: { de: "Danke für die Einladung.", it: ["Grazie per l'invito."] } },
    { id: "v150", it: "presentare", de: "vorstellen", cefr: "B1", theme: "social", ex: { de: "Ich stelle dir meinen Mann vor.", it: ["Ti presento mio marito."] } },
    { id: "v151", it: "gentile", de: "nett / freundlich", cefr: "A2", theme: "social", ex: { de: "Der Nachbar ist sehr nett.", it: ["Il vicino è molto gentile."] } },
    { id: "v152", it: "simpatico", de: "sympathisch", cefr: "A2", theme: "social", ex: { de: "Deine Freundin ist sympathisch.", it: ["La tua amica è simpatica."] } },
    { id: "v153", it: "insieme", de: "zusammen", cefr: "A2", theme: "social", ex: { de: "Wir essen zusammen.", it: ["Mangiamo insieme."] } },
    { id: "v154", it: "volentieri", de: "gern", cefr: "A2", theme: "social", ex: { de: "Ich komme gern.", it: ["Vengo volentieri."] } },
    { id: "v155", it: "d'accordo", de: "einverstanden", cefr: "A2", theme: "social", ex: { de: "Wir sind einverstanden.", it: ["Siamo d'accordo."] } },
    { id: "v156", it: "il regalo", de: "das Geschenk", cefr: "A2", theme: "social", ex: { de: "Ein Geschenk für die Oma.", it: ["Un regalo per la nonna."] } },
    { id: "v157", it: "la festa", de: "das Fest / die Party", cefr: "A1", theme: "social", ex: { de: "Die Party ist am Samstag.", it: ["La festa è sabato."] } },
    { id: "v158", it: "il compleanno", de: "der Geburtstag", cefr: "A2", theme: "social", ex: { de: "Heute ist mein Geburtstag.", it: ["Oggi è il mio compleanno."] } },
    { id: "v159", it: "festeggiare", de: "feiern", cefr: "B1", theme: "social", ex: { de: "Wir feiern den Geburtstag.", it: ["Festeggiamo il compleanno."] } },
    { id: "v160", it: "l'amico", de: "der Freund", cefr: "A1", theme: "social", ex: { de: "Mein Freund heißt Marco.", it: ["Il mio amico si chiama Marco."] } },
    { id: "v161", it: "l'amica", de: "die Freundin", cefr: "A1", theme: "social", ex: { de: "Meine Freundin kommt heute Abend.", it: ["La mia amica viene stasera."] } },
    { id: "v162", it: "il vicino", de: "der Nachbar", cefr: "A2", theme: "social", ex: { de: "Der Nachbar ist zu Hause.", it: ["Il vicino è a casa."] } },

    // --- Familie ---
    { id: "v163", it: "la famiglia", de: "die Familie", cefr: "A1", theme: "family", ex: { de: "Meine Familie ist groß.", it: ["La mia famiglia è grande."] } },
    { id: "v164", it: "il figlio", de: "der Sohn", cefr: "A1", theme: "family", ex: { de: "Mein Sohn ist klein.", it: ["Mio figlio è piccolo."] } },
    { id: "v165", it: "la figlia", de: "die Tochter", cefr: "A1", theme: "family", ex: { de: "Meine Tochter schläft.", it: ["Mia figlia dorme."] } },
    { id: "v166", it: "il fratello", de: "der Bruder", cefr: "A1", theme: "family", ex: { de: "Ich habe einen Bruder.", it: ["Ho un fratello."] } },
    { id: "v167", it: "i nipoti", de: "die Enkel / Neffen", cefr: "A2", theme: "family", ex: { de: "Die Oma liebt ihre Enkel.", it: ["La nonna ama i nipoti."] } },
    { id: "v168", it: "la zia", de: "die Tante", cefr: "A2", theme: "family", ex: { de: "Meine Tante kocht gut.", it: ["Mia zia cucina bene."] } },
    { id: "v169", it: "lo zio", de: "der Onkel", cefr: "A2", theme: "family", ex: { de: "Mein Onkel kommt morgen.", it: ["Mio zio viene domani."] } },
    { id: "v170", it: "il cugino", de: "der Cousin", cefr: "A2", theme: "family", ex: { de: "Mein Cousin wohnt in Rom.", it: ["Mio cugino abita a Roma."] } },
    { id: "v171", it: "sposato", de: "verheiratet", cefr: "A2", theme: "family", ex: { de: "Ich bin verheiratet.", it: ["Sono sposata.", "Sono sposato."] } },
    { id: "v172", it: "il matrimonio", de: "die Hochzeit", cefr: "B1", theme: "family", ex: { de: "Die Hochzeit ist im Juni.", it: ["Il matrimonio è a giugno."] } },
    { id: "v173", it: "voler bene", de: "lieb haben", cefr: "B1", theme: "family", ex: { de: "Ich hab dich lieb.", it: ["Ti voglio bene."] } },
    { id: "v174", it: "litigare", de: "streiten", cefr: "B1", theme: "family", ex: { de: "Die Kinder streiten.", it: ["I bambini litigano."] } },

    // --- Tägliches Leben ---
    { id: "v175", it: "svegliarsi", de: "aufwachen", cefr: "A2", theme: "routine", ex: { de: "Ich wache früh auf.", it: ["Mi sveglio presto."] } },
    { id: "v176", it: "alzarsi", de: "aufstehen", cefr: "A2", theme: "routine", ex: { de: "Ich stehe um sieben auf.", it: ["Mi alzo alle sette."] } },
    { id: "v177", it: "lavarsi", de: "sich waschen", cefr: "A2", theme: "routine", ex: { de: "Ich wasche mich morgens.", it: ["Mi lavo la mattina."] } },
    { id: "v178", it: "vestirsi", de: "sich anziehen", cefr: "A2", theme: "routine", ex: { de: "Das Kind zieht sich an.", it: ["Il bambino si veste."] } },
    { id: "v179", it: "riposarsi", de: "sich ausruhen", cefr: "A2", theme: "routine", ex: { de: "Am Abend ruhe ich mich aus.", it: ["La sera mi riposo."] } },
    { id: "v180", it: "addormentarsi", de: "einschlafen", cefr: "B1", theme: "routine", ex: { de: "Das Baby schläft schnell ein.", it: ["Il bambino si addormenta presto."] } },
    { id: "v181", it: "fare la spesa", de: "einkaufen (Lebensmittel)", cefr: "A2", theme: "routine", ex: { de: "Ich kaufe Lebensmittel ein.", it: ["Faccio la spesa."] } },
    { id: "v182", it: "lavare i piatti", de: "abwaschen", cefr: "A2", theme: "routine", ex: { de: "Ich wasche nach dem Essen ab.", it: ["Lavo i piatti dopo cena."] } },
    { id: "v183", it: "uscire", de: "ausgehen / rausgehen", cefr: "A2", theme: "routine", ex: { de: "Heute Abend gehen wir aus.", it: ["Stasera usciamo."] } },
    { id: "v184", it: "rimanere", de: "bleiben", cefr: "A2", theme: "routine", ex: { de: "Ich bleibe zu Hause.", it: ["Rimango a casa."] } },
    { id: "v185", it: "dimenticare", de: "vergessen", cefr: "A2", theme: "routine", ex: { de: "Ich vergesse immer die Schlüssel.", it: ["Dimentico sempre le chiavi."] } },
    { id: "v186", it: "ricordare", de: "sich erinnern", cefr: "A2", theme: "routine", ex: { de: "Ich erinnere mich gut.", it: ["Ricordo bene.", "Mi ricordo bene."] } },
    { id: "v187", it: "la chiave", de: "der Schlüssel", cefr: "A2", theme: "home", ex: { de: "Wo ist der Schlüssel?", it: ["Dov'è la chiave?"] } },
    { id: "v188", it: "il telefono", de: "das Telefon", cefr: "A1", theme: "phone", ex: { de: "Das Telefon klingelt.", it: ["Il telefono squilla."] } },
    { id: "v189", it: "telefonare", de: "telefonieren / anrufen", cefr: "A2", theme: "phone", ex: { de: "Ich rufe meine Mutter an.", it: ["Telefono a mia mamma."] } },
    { id: "v190", it: "il messaggio", de: "die Nachricht", cefr: "A2", theme: "phone", ex: { de: "Ich schreibe eine Nachricht.", it: ["Scrivo un messaggio."] } },
    { id: "v191", it: "ascoltare", de: "(zu)hören", cefr: "A2", theme: "routine", ex: { de: "Ich höre Musik.", it: ["Ascolto la musica."] } },
    { id: "v192", it: "la musica", de: "die Musik", cefr: "A1", theme: "routine", ex: { de: "Die Musik ist schön.", it: ["La musica è bella."] } },
    { id: "v193", it: "guardare", de: "schauen / ansehen", cefr: "A1", theme: "routine", ex: { de: "Wir sehen abends fern.", it: ["Guardiamo la TV la sera."] } }
  ],
